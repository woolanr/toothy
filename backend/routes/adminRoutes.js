...
router.get('/booking/available-slots', protect, authorizeRoles(4), userController.getAvailableDoctorSlots);
router.post('/booking/create', protect, authorizeRoles(4), userController.bookAppointment);
